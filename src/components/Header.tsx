...
import { FaLeaf, FaBoxOpen, FaStore, FaShoppingBag } from "react-icons/fa";
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link
              to="/cart"
              className="relative flex items-center hover:text-orange-400 transition-colors"
            >
