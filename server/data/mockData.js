...
export const enhancedMockProducts = [
  ...
  // Additional products for better search testing
  {
    ...
    reviews: 423,
    description:
      "Modular smartphone designed for longevity with replaceable parts and ethical sourcing.",
    features: [
      "Modular Design",
      "Replaceable Parts",
      "Ethical Sourcing",
    ...
    ecoScore: 88,
    sustainabilityInfo:
      "Fair trade materials, modular design for repairability",
    inStock: true,
  ...
  },
  {
    ...
    reviews: 234,
    description:
      "Revolutionary modular laptop with upgradeable ports and components.",
    features: [
      "Modular Ports",
      "Upgradeable",
      "Repairable Design",
    ...
    ecoScore: 85,
    sustainabilityInfo:
      "Designed for longevity and repairability to reduce e-waste",
    inStock: true,
...
export const mockUsers = [
  {
    ...
    location: { lat: 28.6139, lng: 77.209, address: "Delhi, India" },
    orders: [],
    ecoTransactions: [],
  },
  {
    ...
    location: { lat: 28.6149, lng: 77.21, address: "Connaught Place, Delhi" },
    orders: [],
    ecoTransactions: [],
  },
  {
    ...
    location: { lat: 28.6129, lng: 77.208, address: "India Gate, Delhi" },
    orders: [],
    ecoTransactions: [],
  },
  {
    ...
    location: { lat: 28.6159, lng: 77.211, address: "Rajiv Chowk, Delhi" },
    orders: [],
    ecoTransactions: [],
  },
  {
...
export const mockOrders = [
  {
    ...
    deliveryLocation: { lat: 28.6139, lng: 77.209 },
  ...
  },
  {
    ...
    deliveryLocation: { lat: 28.6149, lng: 77.21 },
    preferredDeliveryDate: new Date(
      Date.now() + 24 * 60 * 60 * 1000
    ).toISOString(),
  ...
  },
  {
    ...
    userId: "user-3",
    items: [
      { id: "4", category: "Home & Kitchen", title: "Bamboo Coffee Cup" },
    ],
    deliveryLocation: { lat: 28.6129, lng: 77.208 },
    preferredDeliveryDate: new Date(
